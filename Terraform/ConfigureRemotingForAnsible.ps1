...
$Username = "ift"
$Password = ConvertTo-SecureString "Aa123" -AsPlainText -Force

# Create the new local user with the specified password
New-LocalUser -Name $Username -Password $Password -FullName "New User" -Description "This is a new user account."

# Optional: Add the user to the local 'Users' group
